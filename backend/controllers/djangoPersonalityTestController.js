...
exports.sauvegarderResultat = async (req, res) => {
    try {
        ...
        const prompt = `
            À partir des résultats du Test d'évaluation des valeurs et des comportements, veuillez rédiger un rapport structuré selon les points suivants :
             - Introduction
             - Présentez brièvement le Test d'évaluation des valeurs et des comportements, en expliquant son objectif et ce qu'il mesure.
