...
exports.sauvegarderResultat = async (req, res) => {
    try {
        ...
        const prompt = `
            À partir des résultats du MBTI test, veuillez rédiger un rapport structuré selon les points suivants :
             - Introduction
             - Présentez brièvement le MBTI test, en expliquant son objectif et ce qu'il mesure.
