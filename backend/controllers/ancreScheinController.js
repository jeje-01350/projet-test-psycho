const ResultsAncreSchein = require("../models/ResultsAncreSchein");
...
exports.sauvegarderResultat = async (req, res) => {
    try {
        ...
        const prompt = `
            À partir des résultats du test Ancres de Schein, veuillez rédiger un rapport structuré selon les points suivants :
             - Introduction
             - Présentez brièvement le test Ancres de Schein, en expliquant son objectif et ce qu'il mesure.
