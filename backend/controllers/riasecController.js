...
exports.sauvegarderResultat = async (req, res) => {
    try {
        ...
        const prompt = `
            À partir des résultats du test RIASEC, veuillez rédiger un rapport structuré selon les points suivants :
             - Introduction
             - Présentez brièvement le test RIASEC, en expliquant son objectif et ce qu'il mesure.
