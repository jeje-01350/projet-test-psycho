...
exports.sauvegarderResultat = async (req, res) => {
    try {
        ...
        const prompt = `
            À partir des résultats du test PAPI (Personality and Preference Inventory), veuillez rédiger un rapport structuré selon les points suivants :
             - Introduction
             - Présentez brièvement le test PAPI (Personality and Preference Inventory), en expliquant son objectif et ce qu'il mesure.
